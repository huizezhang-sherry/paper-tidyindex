...
The construction of natural hazard indexes also follows a set of steps, which is usually illustrated using a flowchart in the paper. 

* constructing time series index should also be encapsulated in the framework

Here we assume a concept of interest is determined, relevant variables/ indicators are identified and available to construct indexes.
