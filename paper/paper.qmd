...
Information from neighbouring spatial locations can also be borrowed when constructing indexes. 
...
While many indexes are calculated independently on spatial locations

satellite images with different resolutions
matching ground and satellite images data 
