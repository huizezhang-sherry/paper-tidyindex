...
As a scripted language for data analysis, R provides a interactive environment for users to code with data without the abstraction a typical programming language requires. 
This flexible environment is paramount for data analysis since in practice, data analysis is an iterative process that involves trials and errors to solve the problems.
Analysts need the freedom to quickly experiment with different ideas when working with data.
...
<!-- While data can be arranged in various different ways, maintaining a fixed representation gives a predictable output of operations on data.  -->

<!-- Only when each step in the workflow has been mapped out, do data analysts need to consider those abstract concept of object oriented programming and functional programming to help them design the workflow.  -->
<!-- how raw data should be processed to the final results can only be consolidated when  -->
...
The concept of pipeline (and pipe) is not new concept to computing. It refers to a set of data processing elements connected in series, where the output of one element is the input of the next one.
