...
This flexible environment is paramount for data analysis since in practice, data analysis involves trials and errors on different steps to solve the problems.
...
All of these are built upon a simple prior knowledge of the tidy data principle [@wickham_tidy_2014], which prescribes three rules for structuring tabular data: 1) Each variable forms a column, 2) Each observation forms a row, and; 3) Each type of observational unit forms a table.


Constructing indices also involves this working pattern of trails and errors on different options before finding the final solution. A tidy workflow will give researchers more flexibility to tune the steps as they wish and while maintain a readable and intuitive code base.
