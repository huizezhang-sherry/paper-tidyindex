...
Its main different from variable transformation is that scaling does not change the shape of the data and it can usually be written in the form of $$[x(s_i;t_j) - \alpha]/\gamma.$$
@fig-scale-var-trans-compare shows a range of operations on a simulated variable. 
