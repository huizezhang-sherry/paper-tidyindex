...
\ifdefined\Shaded\renewenvironment{Shaded}{\begin{tcolorbox}[enhanced, boxrule=0pt, borderline west={3pt}{0pt}{shadecolor}, sharp corners, breakable, interior hidden, frame hidden]}{\end{tcolorbox}}\fi
...
Information from neighbouring spatial locations can also be borrowed
when constructing indexes. This involves interpolating data from
observed locations to the unobserved and aggregating data into different
levels. In the pipeline, spatial aggregation can be written as
...
satellite images with different resolutions matching ground and
