...
The rest of the paper is structured as follows: @sec-tidy reviews the tidy framework in R and how index construction can benefit from such a framework. The details of the pipeline modules are presented in @sec-pipeline. @sec-dev explains the design of the `tidyindex` pacakge that implements the modules. Examples are given in @sec-examples to illustrate the use cases of the pipeline.
