...
```{r tbl-gggi-weights}
#| tbl-cap: "Weights for the two applications of dimension reduction to compute the Global Gender Gap Index. V-weight is used to compute four new variables from the original 14. These are then equally combined to get the final index value."
...
gggi_weights %>%  
  ...
  knitr::kable(
    digits = 3, 
    col.names = c("Variable", "V-weight", "Dimension", 
        "D-weight"),
        linesep = c("", "", "", "", "\\hline",
                    "", "", "", "\\hline",
                    "", "\\hline",
