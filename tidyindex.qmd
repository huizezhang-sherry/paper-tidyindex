...
<!-- The workflow to construct indexes are more similar to the one for machine learning models with several components commonly used across most of the indexes. Indexes typically take inputs from multivariate data and combine them into a univariate series -- this is a dimension reduction step. Indexes are often series that traced over time, hence a temporal component. -->
