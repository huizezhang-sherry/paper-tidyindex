...
When health receives a higher weight, the impact on the index value is minimal. 
...
* Bangladesh uses politics to compensate economy
* increase economy -> 
* increase education -> 
* increase health -> shrink the range of index (bring top and bottom country closer)
* increase politics -> all the country has index value smaller
