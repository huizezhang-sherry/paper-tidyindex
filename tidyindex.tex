...
the same purpose cannot easily be compared. This violates \emph{tidy
principles} (Wickham et al. 2019a) which makes it difficult to
investigate the nature of calculations through a principled data
pipeline. It also violates statistical principles, where quantifying and
understanding uncertainty are essential to deciding on a best measure or
metric {[}@???Spiegelhalter, someone else{]}.
...
tidyverse suite (Wickham et al. 2019b) takes the pipeline approach for
