...
Index (SPI), and can be considered to be a dimension reduction using a
...
principal component analysis (PCA) (XXX-ref) or linear discriminant
analysis (XXX-ref), preparing contrasts to test particular elements in
analysis of variance, or hand-crafted by a content-area expert. Linear
combinations also form the basis for visualizing multivariate data, in
methods such as tours (XXX-ref).
...
projections is known as a ``local tour''. XXX-ref to tourr package, and
also tour theory paper (Buja
