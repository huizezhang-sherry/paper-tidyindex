...
\begin{equation}
\mathbf{x}(s;t) = \{x^1(s;t), x^2(s;t), \cdots, x^p(s;t)\} \qquad s \in D_s \subseteq \mathbb{R}^d, t \in D_t \subseteq \mathbb{R}^m 
\end{equation}
...
\item
  ...
  \(D_s \subseteq \mathbb{R}^d\). This includes a collection of
  countries of interest and paired longitude and latitude coordinates of
  locations, and
\item
  \(t\) denotes the temporal order in \(D_t \subseteq \mathbb{R}^m\).
  Sometimes, it can be time decomposed into several components, such as
