...
availability and the choice in other similar indexes. In indexes
constructed from linear combination of variables, decisions need to be
made on the weight assigned to each variable. In the case of a drought
index, analysts may need to decide among similar indexes, on the time
scale to aggregate precipitation, and the distribution used to fit the
data. All these decisions can introduce uncertainty to the index and
