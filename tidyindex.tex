...
in tidying up routine data analyses {[}XXX tidyr, dplyr, tidymodels,
\ldots, tsibble, cubble{]} that ``turn ideas into software quickly and
faithfully'', as envisioned by (\textbf{chambers?}). Index development
and use needs tidying. .
