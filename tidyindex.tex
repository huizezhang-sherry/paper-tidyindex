...
software design
\end{keywords}
\ifdefined\Shaded\renewenvironment{Shaded}{\begin{tcolorbox}[breakable, sharp corners, borderline west={3pt}{0pt}{shadecolor}, frame hidden, interior hidden, enhanced, boxrule=0pt]}{\end{tcolorbox}}\fi
...
\includegraphics{tidyindex_files/figure-pdf/gggi-verify-1.pdf}

\begin{figure}

{\centering \includegraphics{tidyindex_files/figure-pdf/gggi-weights-1.pdf}
...
{\centering \includegraphics{tidyindex_files/figure-pdf/idx-tour-1.pdf}

}

\caption{Five frames selected from varying the linear weights of four
dimensions in Global Gender Gap Index. The weights vary slightly from
the official simple average weights (0.25, 0.25, 0.25, 0.25) to observe
how the index and ranking reponse. Full animation is available at
{[}vimeo link{]}.}
