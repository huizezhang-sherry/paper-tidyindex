...
in Section~\ref{sec-pipeline}. Section~\ref{sec-dev} explains the design
of the \texttt{tidyindex} pacakge that implements the modules. Examples
are given in Section~\ref{sec-examples} to illustrate the use cases of
the pipeline.
