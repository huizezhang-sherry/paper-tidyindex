...
dimension reduction technique is Principal Component Analysis (PCA). It
can be seen as a special case of weighting, where variables are summed
up in a linear combination:
