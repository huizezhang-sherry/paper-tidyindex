...
design of the \texttt{tidyindex} pacakge that implements the modules.
...
The state of Queensland in Australia frequently experience natural
...
parameter used (\texttt{.scale}, \texttt{.method}, and \texttt{.dist}),
